...
class NotificationManager: ObservableObject {
    ...
    func logOrderStarted() {
        Analytics.logEvent("order_started", parameters: [
    ...
    func logStepCompleted(step: Int) {
        Analytics.logEvent("step_completed", parameters: [
            "step_number": step,
            "timestamp": Int(Date().timeIntervalSince1970)
        ])
    ...
    func logESIMProvisioned() {
        Analytics.logEvent("esim_provisioned", parameters: [
            "timestamp": Int(Date().timeIntervalSince1970),
            "sim_type": "eSIM"
        ])
    ...
    func logESIMSetupStarted() {
        Analytics.logEvent("esim_setup_started", parameters: [
            "timestamp": Int(Date().timeIntervalSince1970)
        ])
    ...
    func logESIMSetupCompleted() {
        Analytics.logEvent("esim_setup_completed", parameters: [
            "timestamp": Int(Date().timeIntervalSince1970)
        ])
