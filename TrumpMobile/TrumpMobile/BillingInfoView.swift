...
struct BillingInfoView: View {
    ...
    var body: some View {
        StepNavigationContainer(
            ...
            nextButtonDisabled: creditCardNumber.isEmpty || expirationDate.isEmpty || cvv.isEmpty || !agreeE911 || !agreeRecurringCharge || !agreePrivacyTerms,
            nextButtonAction: {
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    Text("Please enter the serial number (IMEI) of your phone to see if it can work on our network before proceeding to enter the Billing Information")
                        .font(.caption)
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        HStack(alignment: .top, spacing: 8) {
                            ...
                            Text("I confirm that the address provided is my E911 address, which will be used by first responders in case of an emergency.")
                                .font(.caption)
                                .foregroundColor(.gray)
                        ...
                        HStack(alignment: .top, spacing: 8) {
                            ...
                            Text("By checking this box, you authorize Trump Mobile LLC to charge your card on a recurring basis. You can cancel the service at any time to stop future charges.")
                                .font(.caption)
                                .foregroundColor(.gray)
                                .fixedSize(horizontal: false, vertical: true)
                        }
                        ...
                        HStack(alignment: .top, spacing: 8) {
                            ...
                            Text("You are acknowledging your agreement to our Privacy Policy and Terms of Use by creating an account or logging into your TrumpGM Mobile account.")
                                .font(.caption)
                                .foregroundColor(.gray)
                                .fixedSize(horizontal: false, vertical: true)
                        }
